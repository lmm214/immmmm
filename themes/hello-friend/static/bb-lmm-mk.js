...
for(var i=0;i < data.length;i++){
    ...
    var memosIdNow = memos.replace(/https\:\/\/.*\.(.*)\..*/,'id-$1-')
    var emojiReaction = '<emoji-reaction theme="system" class="reaction" endpoint="https://api-emaction.immmmm.com" reacttargetid="'+memosIdNow+'memo-'+data[i].id+'"></emoji-reaction>'
