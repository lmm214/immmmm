...
function showTaglist(){
    let bbUrl = 'https://api-memos.immmmm.com/'
    let tagListDom = ""
    fetch(bbUrl).then(res => res.json()).then( resdata =>{
