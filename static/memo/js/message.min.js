...
function _typeof(o) {
  ...
  function a(e) {
    ...
    return 0 !== i && setTimeout(function () {
        f(h, d)
      }, i), m.children.length || document.body.appendChild(m), m.appendChild(h), t(h, {
  ...
  function f(o, n) {
    o && (t(o, {
      padding: 0,
      height: 0
    }), e(o.children[0], "coco-msg-fade-out"), n && n(), setTimeout(function () {
      if (o) {
        for (var t = !1, e = 0; e < m.children.length; e++) m.children[e] === o && (t = !0);
